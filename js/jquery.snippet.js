...
(function($) {
	...
	$.fn.snippet = function(language,settings) {
		...
		var styleArr = ["ide-msvcpp"];
		//下面数组的每一个对应一个高亮样式，放到上面即可
		var stylearr = [
			"acid","berries-dark",
				"berries-light","bipolar","blacknblue",
				"bright","contrast","darkblue","darkness",
				"desert","dull","easter","emacs","golden","greenlcd","ide-anjuta",
				"ide-codewarrior","ide-devcpp","ide-eclipse","ide-kdev","ide-msvcpp",
				"kwrite","matlab","navy","nedit","neon","night","pablo","peachpuff",
				"print","rand01","the","typical","vampire","vim","vim-dark","whatis",
				"whitengrey","zellner"
		]
			...
			if(node == "pre"){
				...
				if(!o.parent().hasClass("snippet-wrap")){
					...
					if(defaults.collapse){
						...
						var collapseHide = "<div class='sh_sourceCode snippet-hide'><pre></pre></div>";
